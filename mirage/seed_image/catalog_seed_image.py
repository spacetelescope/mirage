...
class Catalog_seed():
    ...
    def RADecToXY_astrometric(self, ra, dec):
        ...
        if not self.use_intermediate_aperture:
            ...
            print('\n\nV2, V3 from intermediate aperture: ', loc_v2, loc_v3)
        ...
        if self.coord_transform is not None:
            ...
            print('X, Y from dist reffile: ', pixelx, pixely)
            print(self.subarray_bounds[0], self.subarray_bounds[1])
            ...
            print('X, Y from self.siaf: ', pixelx, pixely)
